...
export const ActionResult: MessageFns<ActionResult> = {
  ...
  fromJSON(object: any): ActionResult {
    return {
      ...
      worldEntities: isSet(object.worldEntities)
        ? WorldEntitiesResult.fromJSON(object.worldEntities)
        : isSet(object.world_entities)
        ? WorldEntitiesResult.fromJSON(object.world_entities)
        : undefined,
      worldPlayers: isSet(object.worldPlayers)
        ? WorldPlayersResult.fromJSON(object.worldPlayers)
        : isSet(object.world_players)
        ? WorldPlayersResult.fromJSON(object.world_players)
        : undefined,
      worldEntitiesWithin: isSet(object.worldEntitiesWithin)
        ? WorldEntitiesWithinResult.fromJSON(object.worldEntitiesWithin)
        : isSet(object.world_entities_within)
        ? WorldEntitiesWithinResult.fromJSON(object.world_entities_within)
        : undefined,
      worldDefaultGameMode: isSet(object.worldDefaultGameMode)
        ? WorldDefaultGameModeResult.fromJSON(object.worldDefaultGameMode)
        : isSet(object.world_default_game_mode)
        ? WorldDefaultGameModeResult.fromJSON(object.world_default_game_mode)
        : undefined,
      worldPlayerSpawn: isSet(object.worldPlayerSpawn)
        ? WorldPlayerSpawnResult.fromJSON(object.worldPlayerSpawn)
        : isSet(object.world_player_spawn)
        ? WorldPlayerSpawnResult.fromJSON(object.world_player_spawn)
        : undefined,
      worldBlock: isSet(object.worldBlock)
        ? WorldBlockResult.fromJSON(object.worldBlock)
        : isSet(object.world_block)
        ? WorldBlockResult.fromJSON(object.world_block)
        : undefined,
      worldBiome: isSet(object.worldBiome)
        ? WorldBiomeResult.fromJSON(object.worldBiome)
        : isSet(object.world_biome)
        ? WorldBiomeResult.fromJSON(object.world_biome)
        : undefined,
      worldLight: isSet(object.worldLight)
        ? WorldLightResult.fromJSON(object.worldLight)
        : isSet(object.world_light)
        ? WorldLightResult.fromJSON(object.world_light)
        : undefined,
      worldSkyLight: isSet(object.worldSkyLight)
        ? WorldSkyLightResult.fromJSON(object.worldSkyLight)
        : isSet(object.world_sky_light)
        ? WorldSkyLightResult.fromJSON(object.world_sky_light)
        : undefined,
      worldTemperature: isSet(object.worldTemperature)
        ? WorldTemperatureResult.fromJSON(object.worldTemperature)
        : isSet(object.world_temperature)
        ? WorldTemperatureResult.fromJSON(object.world_temperature)
        : undefined,
      worldHighestBlock: isSet(object.worldHighestBlock)
        ? WorldHighestBlockResult.fromJSON(object.worldHighestBlock)
        : isSet(object.world_highest_block)
        ? WorldHighestBlockResult.fromJSON(object.world_highest_block)
        : undefined,
      worldRainingAt: isSet(object.worldRainingAt)
        ? WorldRainingAtResult.fromJSON(object.worldRainingAt)
        : isSet(object.world_raining_at)
        ? WorldRainingAtResult.fromJSON(object.world_raining_at)
        : undefined,
      worldSnowingAt: isSet(object.worldSnowingAt)
        ? WorldSnowingAtResult.fromJSON(object.worldSnowingAt)
        : isSet(object.world_snowing_at)
        ? WorldSnowingAtResult.fromJSON(object.world_snowing_at)
        : undefined,
      worldThunderingAt: isSet(object.worldThunderingAt)
        ? WorldThunderingAtResult.fromJSON(object.worldThunderingAt)
        : isSet(object.world_thundering_at)
        ? WorldThunderingAtResult.fromJSON(object.world_thundering_at)
        : undefined,
      worldLiquid: isSet(object.worldLiquid)
        ? WorldLiquidResult.fromJSON(object.worldLiquid)
        : isSet(object.world_liquid)
        ? WorldLiquidResult.fromJSON(object.world_liquid)
        : undefined,
    };
  },
...
export const WorldLightResult: MessageFns<WorldLightResult> = {
  ...
  fromJSON(object: any): WorldLightResult {
    return {
      world: isSet(object.world) ? WorldRef.fromJSON(object.world) : undefined,
      position: isSet(object.position) ? BlockPos.fromJSON(object.position) : undefined,
      lightLevel: isSet(object.lightLevel)
        ? globalThis.Number(object.lightLevel)
        : isSet(object.light_level)
        ? globalThis.Number(object.light_level)
        : 0,
    };
  },
...
export const WorldSkyLightResult: MessageFns<WorldSkyLightResult> = {
  ...
  fromJSON(object: any): WorldSkyLightResult {
    return {
      world: isSet(object.world) ? WorldRef.fromJSON(object.world) : undefined,
      position: isSet(object.position) ? BlockPos.fromJSON(object.position) : undefined,
      skyLightLevel: isSet(object.skyLightLevel)
        ? globalThis.Number(object.skyLightLevel)
        : isSet(object.sky_light_level)
        ? globalThis.Number(object.sky_light_level)
        : 0,
    };
  },
