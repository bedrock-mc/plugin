        ...
        return {
            ...
            customItems: globalThis.Array.isArray(object?.customItems)
                ...
                : globalThis.Array.isArray(object?.custom_items)
                    ? object.custom_items.map((e) => CustomItemDefinition.fromJSON(e))
                    : [],
            customBlocks: globalThis.Array.isArray(object?.customBlocks)
                ...
                : globalThis.Array.isArray(object?.custom_blocks)
                    ? object.custom_blocks.map((e) => CustomBlockDefinition.fromJSON(e))
                    : [],
        };
    },
    toJSON(message) {
    ...
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 2: {
                    if (tag === 16) {
                        message.observeEvents.push(reader.int32());
                        continue;
                    }
                    if (tag === 18) {
                        const end2 = reader.uint32() + reader.pos;
    ...
    fromJSON(object) {
        return {
            ...
            observeEvents: globalThis.Array.isArray(object?.observeEvents)
                ? object.observeEvents.map((e) => eventTypeFromJSON(e))
                : globalThis.Array.isArray(object?.observe_events)
                    ? object.observe_events.map((e) => eventTypeFromJSON(e))
                    : [],
        };
    },
    toJSON(message) {
