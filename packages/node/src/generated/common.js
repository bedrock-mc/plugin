...
export var CustomBlockRenderMethod;
(function (CustomBlockRenderMethod) {
    CustomBlockRenderMethod[CustomBlockRenderMethod["CUSTOM_BLOCK_RENDER_METHOD_OPAQUE"] = 0] = "CUSTOM_BLOCK_RENDER_METHOD_OPAQUE";
    CustomBlockRenderMethod[CustomBlockRenderMethod["CUSTOM_BLOCK_RENDER_METHOD_ALPHA_TEST"] = 1] = "CUSTOM_BLOCK_RENDER_METHOD_ALPHA_TEST";
    CustomBlockRenderMethod[CustomBlockRenderMethod["CUSTOM_BLOCK_RENDER_METHOD_BLEND"] = 2] = "CUSTOM_BLOCK_RENDER_METHOD_BLEND";
    CustomBlockRenderMethod[CustomBlockRenderMethod["CUSTOM_BLOCK_RENDER_METHOD_DOUBLE_SIDED"] = 3] = "CUSTOM_BLOCK_RENDER_METHOD_DOUBLE_SIDED";
    CustomBlockRenderMethod[CustomBlockRenderMethod["UNRECOGNIZED"] = -1] = "UNRECOGNIZED";
})(CustomBlockRenderMethod || (CustomBlockRenderMethod = {}));
export function customBlockRenderMethodFromJSON(object) {
    switch (object) {
        case 0:
...
export function customBlockRenderMethodToJSON(object) {
    switch (object) {
...
export const LiquidState = {
    ...
    fromJSON(object) {
        return {
            ...
            liquidType: isSet(object.liquidType)
                ? globalThis.String(object.liquidType)
                : isSet(object.liquid_type)
                    ? globalThis.String(object.liquid_type)
                    : "",
        };
    },
    toJSON(message) {
        ...
        return {
            ...
            displayName: isSet(object.displayName)
                ...
                : isSet(object.display_name)
                    ...
                    : "",
            textureData: isSet(object.textureData)
                ? bytesFromBase64(object.textureData)
                : isSet(object.texture_data)
                    ? bytesFromBase64(object.texture_data)
                    : new Uint8Array(0),
...
function createBaseCustomBlockTexture() {
    return { name: "", imagePng: new Uint8Array(0) };
}
export const CustomBlockTexture = {
    encode(message, writer = new BinaryWriter()) {
        if (message.name !== "") {
            writer.uint32(10).string(message.name);
        }
    ...
    fromJSON(object) {
        return {
            name: isSet(object.name) ? globalThis.String(object.name) : "",
            imagePng: isSet(object.imagePng)
                ? bytesFromBase64(object.imagePng)
                : isSet(object.image_png)
                    ? bytesFromBase64(object.image_png)
                    : new Uint8Array(0),
        };
    },
    toJSON(message) {
...
export const CustomBlockMaterial = {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 3: {
                    ...
                    message.renderMethod = reader.int32();
                    continue;
                }
                case 4: {
                    if (tag !== 32) {
    ...
    fromJSON(object) {
        return {
            ...
            textureName: isSet(object.textureName)
            ...
            renderMethod: isSet(object.renderMethod)
                ? customBlockRenderMethodFromJSON(object.renderMethod)
                : isSet(object.render_method)
                    ? customBlockRenderMethodFromJSON(object.render_method)
                    : 0,
            faceDimming: isSet(object.faceDimming)
                ? globalThis.Boolean(object.faceDimming)
                : isSet(object.face_dimming)
                    ? globalThis.Boolean(object.face_dimming)
                    : undefined,
            ambientOcclusion: isSet(object.ambientOcclusion)
                ? globalThis.Boolean(object.ambientOcclusion)
                : isSet(object.ambient_occlusion)
                    ? globalThis.Boolean(object.ambient_occlusion)
                    : undefined,
        };
    },
    toJSON(message) {
...
function createBaseCustomBlockProperties() {
    return {
...
export const CustomBlockProperties = {
    encode(message, writer = new BinaryWriter()) {
        ...
        globalThis.Object.entries(message.states).forEach(([key, value]) => {
            CustomBlockProperties_StatesEntry.encode({ key: key, value }, writer.uint32(162).fork()).join();
        });
    ...
    fromJSON(object) {
        return {
            collisionBox: isSet(object.collisionBox)
                ? BBox.fromJSON(object.collisionBox)
                : isSet(object.collision_box)
                    ? BBox.fromJSON(object.collision_box)
                    : undefined,
            selectionBox: isSet(object.selectionBox)
                ? BBox.fromJSON(object.selectionBox)
                : isSet(object.selection_box)
                    ? BBox.fromJSON(object.selection_box)
                    : undefined,
            geometryIdentifier: isSet(object.geometryIdentifier)
                ? globalThis.String(object.geometryIdentifier)
                : isSet(object.geometry_identifier)
                    ? globalThis.String(object.geometry_identifier)
                    : undefined,
            cube: isSet(object.cube) ? globalThis.Boolean(object.cube) : false,
            mapColour: isSet(object.mapColour)
                ? globalThis.String(object.mapColour)
                : isSet(object.map_colour)
                    ? globalThis.String(object.map_colour)
                    : undefined,
            ...
            materials: globalThis.Array.isArray(object?.materials)
                ? object.materials.map((e) => CustomBlockMaterial.fromJSON(e))
                : [],
            states: isObject(object.states)
                ? globalThis.Object.entries(object.states).reduce((acc, [key, value]) => {
                    acc[key] = CustomBlockStateValues.fromJSON(value);
                    return acc;
                }, {})
                : {},
            permutations: globalThis.Array.isArray(object?.permutations)
                ? object.permutations.map((e) => CustomBlockPermutation.fromJSON(e))
                : [],
        };
    },
    toJSON(message) {
        ...
        if (message.states) {
            const entries = globalThis.Object.entries(message.states);
            if (entries.length > 0) {
                obj.states = {};
                entries.forEach(([k, v]) => {
    ...
    fromPartial(object) {
        ...
        message.states = globalThis.Object.entries(object.states ?? {}).reduce((acc, [key, value]) => {
            if (value !== undefined) {
...
function createBaseCustomBlockProperties_StatesEntry() {
    return { key: "", value: undefined };
}
export const CustomBlockProperties_StatesEntry = {
    encode(message, writer = new BinaryWriter()) {
        if (message.key !== "") {
            writer.uint32(10).string(message.key);
        }
...
function createBaseCustomBlockDefinition() {
    ...
    fromJSON(object) {
        return {
            ...
            geometryJson: isSet(object.geometryJson)
                ? bytesFromBase64(object.geometryJson)
                : isSet(object.geometry_json)
                    ? bytesFromBase64(object.geometry_json)
                    : undefined,
            textures: globalThis.Array.isArray(object?.textures)
                ? object.textures.map((e) => CustomBlockTexture.fromJSON(e))
                : [],
...
function createBaseCustomBlockStateValues() {
    return { values: [] };
}
export const CustomBlockStateValues = {
    encode(message, writer = new BinaryWriter()) {
...
function createBaseCustomBlockPermutation() {
    return { condition: "", properties: undefined };
}
export const CustomBlockPermutation = {
    encode(message, writer = new BinaryWriter()) {
