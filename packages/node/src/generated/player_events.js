        ...
        return {
            ...
            fullId: isSet(object.fullId)
                ...
                : isSet(object.full_id)
                    ...
                    : undefined,
            playFabId: isSet(object.playFabId)
                ? globalThis.String(object.playFabId)
                : isSet(object.play_fab_id)
                    ? globalThis.String(object.play_fab_id)
                    : undefined,
...
export const PlayerItemUseOnBlockEvent = {
    ...
    fromJSON(object) {
        return {
            ...
            clickPosition: isSet(object.clickPosition)
                ? Vec3.fromJSON(object.clickPosition)
                : isSet(object.click_position)
                    ? Vec3.fromJSON(object.click_position)
                    : undefined,
            block: isSet(object.block) ? BlockState.fromJSON(object.block) : undefined,
            item: isSet(object.item) ? ItemStack.fromJSON(object.item) : undefined,
        };
...
export const PlayerLecternPageTurnEvent = {
    ...
    fromJSON(object) {
        return {
            ...
            world: isSet(object.world) ? globalThis.String(object.world) : "",
            position: isSet(object.position) ? BlockPos.fromJSON(object.position) : undefined,
            oldPage: isSet(object.oldPage)
                ? globalThis.Number(object.oldPage)
                : isSet(object.old_page)
                    ? globalThis.Number(object.old_page)
                    : 0,
    ...
    fromJSON(object) {
        return {
            ...
            averageFramesPerSecond: isSet(object.averageFramesPerSecond)
                ...
                : isSet(object.average_frames_per_second)
                    ? globalThis.Number(object.average_frames_per_second)
                    : 0,
            averageServerSimTickTime: isSet(object.averageServerSimTickTime)
                ? globalThis.Number(object.averageServerSimTickTime)
                : isSet(object.average_server_sim_tick_time)
                    ? globalThis.Number(object.average_server_sim_tick_time)
                    : 0,
            averageClientSimTickTime: isSet(object.averageClientSimTickTime)
                ? globalThis.Number(object.averageClientSimTickTime)
                : isSet(object.average_client_sim_tick_time)
                    ? globalThis.Number(object.average_client_sim_tick_time)
                    : 0,
            averageBeginFrameTime: isSet(object.averageBeginFrameTime)
                ? globalThis.Number(object.averageBeginFrameTime)
                : isSet(object.average_begin_frame_time)
                    ? globalThis.Number(object.average_begin_frame_time)
                    : 0,
            averageInputTime: isSet(object.averageInputTime)
                ? globalThis.Number(object.averageInputTime)
                : isSet(object.average_input_time)
                    ? globalThis.Number(object.average_input_time)
                    : 0,
            averageRenderTime: isSet(object.averageRenderTime)
                ? globalThis.Number(object.averageRenderTime)
                : isSet(object.average_render_time)
                    ? globalThis.Number(object.average_render_time)
                    : 0,
            averageEndFrameTime: isSet(object.averageEndFrameTime)
                ? globalThis.Number(object.averageEndFrameTime)
                : isSet(object.average_end_frame_time)
                    ? globalThis.Number(object.average_end_frame_time)
                    : 0,
            averageRemainderTimePercent: isSet(object.averageRemainderTimePercent)
                ? globalThis.Number(object.averageRemainderTimePercent)
                : isSet(object.average_remainder_time_percent)
                    ? globalThis.Number(object.average_remainder_time_percent)
                    : 0,
            averageUnaccountedTimePercent: isSet(object.averageUnaccountedTimePercent)
                ...
                : isSet(object.average_unaccounted_time_percent)
                    ? globalThis.Number(object.average_unaccounted_time_percent)
                    : 0,
        };
    },
    toJSON(message) {
