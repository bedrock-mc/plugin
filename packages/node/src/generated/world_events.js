...
export const WorldLiquidHardenEvent = {
    ...
    fromJSON(object) {
        return {
            world: isSet(object.world) ? WorldRef.fromJSON(object.world) : undefined,
            position: isSet(object.position) ? BlockPos.fromJSON(object.position) : undefined,
            liquidHardened: isSet(object.liquidHardened)
                ? LiquidState.fromJSON(object.liquidHardened)
                : isSet(object.liquid_hardened)
                    ? LiquidState.fromJSON(object.liquid_hardened)
                    : undefined,
            otherLiquid: isSet(object.otherLiquid)
                ? LiquidState.fromJSON(object.otherLiquid)
                : isSet(object.other_liquid)
                    ? LiquidState.fromJSON(object.other_liquid)
                    : undefined,
            newBlock: isSet(object.newBlock)
                ? BlockState.fromJSON(object.newBlock)
                : isSet(object.new_block)
                    ? BlockState.fromJSON(object.new_block)
                    : undefined,
        };
    },
    toJSON(message) {
    ...
    fromJSON(object) {
        return {
            ...
            affectedEntities: globalThis.Array.isArray(object?.affectedEntities)
                ...
                : globalThis.Array.isArray(object?.affected_entities)
                    ? object.affected_entities.map((e) => EntityRef.fromJSON(e))
                    : [],
            affectedBlocks: globalThis.Array.isArray(object?.affectedBlocks)
                ? object.affectedBlocks.map((e) => BlockPos.fromJSON(e))
                : globalThis.Array.isArray(object?.affected_blocks)
                    ? object.affected_blocks.map((e) => BlockPos.fromJSON(e))
                    : [],
