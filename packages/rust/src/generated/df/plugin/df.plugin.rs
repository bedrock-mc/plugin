...
impl Sound {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            ...
            Self::FireworkLaunch => "FIREWORK_LAUNCH",
            Self::FireworkHugeBlast => "FIREWORK_HUGE_BLAST",
            Self::FireworkBlast => "FIREWORK_BLAST",
            Self::FireworkTwinkle => "FIREWORK_TWINKLE",
            Self::Teleport => "TELEPORT",
            Self::ArrowHit => "ARROW_HIT",
            Self::ItemBreak => "ITEM_BREAK",
            Self::ItemThrow => "ITEM_THROW",
            Self::Totem => "TOTEM",
            Self::FireExtinguish => "FIRE_EXTINGUISH",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
impl ItemCategory {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            Self::Construction => "ITEM_CATEGORY_CONSTRUCTION",
            Self::Nature => "ITEM_CATEGORY_NATURE",
            Self::Equipment => "ITEM_CATEGORY_EQUIPMENT",
            Self::Items => "ITEM_CATEGORY_ITEMS",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
impl CustomBlockRenderMethod {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            Self::Opaque => "CUSTOM_BLOCK_RENDER_METHOD_OPAQUE",
            Self::AlphaTest => "CUSTOM_BLOCK_RENDER_METHOD_ALPHA_TEST",
            Self::Blend => "CUSTOM_BLOCK_RENDER_METHOD_BLEND",
            Self::DoubleSided => "CUSTOM_BLOCK_RENDER_METHOD_DOUBLE_SIDED",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
impl ParticleType {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            Self::Unspecified => "PARTICLE_TYPE_UNSPECIFIED",
            Self::ParticleHugeExplosion => "PARTICLE_HUGE_EXPLOSION",
            Self::ParticleEndermanTeleport => "PARTICLE_ENDERMAN_TELEPORT",
            Self::ParticleSnowballPoof => "PARTICLE_SNOWBALL_POOF",
            Self::ParticleEggSmash => "PARTICLE_EGG_SMASH",
            Self::ParticleSplash => "PARTICLE_SPLASH",
            Self::ParticleEffect => "PARTICLE_EFFECT",
            Self::ParticleEntityFlame => "PARTICLE_ENTITY_FLAME",
            Self::ParticleFlame => "PARTICLE_FLAME",
            Self::ParticleDust => "PARTICLE_DUST",
            Self::ParticleBlockForceField => "PARTICLE_BLOCK_FORCE_FIELD",
            Self::ParticleBoneMeal => "PARTICLE_BONE_MEAL",
            Self::ParticleEvaporate => "PARTICLE_EVAPORATE",
            Self::ParticleWaterDrip => "PARTICLE_WATER_DRIP",
            Self::ParticleLavaDrip => "PARTICLE_LAVA_DRIP",
            Self::ParticleLava => "PARTICLE_LAVA",
            Self::ParticleDustPlume => "PARTICLE_DUST_PLUME",
            Self::ParticleBlockBreak => "PARTICLE_BLOCK_BREAK",
            Self::ParticlePunchBlock => "PARTICLE_PUNCH_BLOCK",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
impl BossBarColour {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            Self::Grey => "BOSS_BAR_COLOUR_GREY",
            Self::Blue => "BOSS_BAR_COLOUR_BLUE",
            Self::Red => "BOSS_BAR_COLOUR_RED",
            Self::Green => "BOSS_BAR_COLOUR_GREEN",
            Self::Yellow => "BOSS_BAR_COLOUR_YELLOW",
            Self::Purple => "BOSS_BAR_COLOUR_PURPLE",
            Self::White => "BOSS_BAR_COLOUR_WHITE",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
impl HudElement {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            Self::PaperDoll => "HUD_ELEMENT_PAPER_DOLL",
            Self::Armour => "HUD_ELEMENT_ARMOUR",
            Self::ToolTips => "HUD_ELEMENT_TOOL_TIPS",
            Self::TouchControls => "HUD_ELEMENT_TOUCH_CONTROLS",
            Self::Crosshair => "HUD_ELEMENT_CROSSHAIR",
            Self::HotBar => "HUD_ELEMENT_HOT_BAR",
            Self::Health => "HUD_ELEMENT_HEALTH",
            Self::ProgressBar => "HUD_ELEMENT_PROGRESS_BAR",
            Self::Hunger => "HUD_ELEMENT_HUNGER",
            Self::AirBubbles => "HUD_ELEMENT_AIR_BUBBLES",
            Self::HorseHealth => "HUD_ELEMENT_HORSE_HEALTH",
            Self::StatusEffects => "HUD_ELEMENT_STATUS_EFFECTS",
            Self::ItemText => "HUD_ELEMENT_ITEM_TEXT",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
impl ParamType {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            ...
            Self::ParamInt => "PARAM_INT",
            Self::ParamFloat => "PARAM_FLOAT",
            Self::ParamBool => "PARAM_BOOL",
            Self::ParamVarargs => "PARAM_VARARGS",
            Self::ParamEnum => "PARAM_ENUM",
            Self::ParamTarget => "PARAM_TARGET",
            Self::ParamTargets => "PARAM_TARGETS",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
impl EventType {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            ...
            Self::All => "EVENT_TYPE_ALL",
            Self::PlayerJoin => "PLAYER_JOIN",
            Self::PlayerQuit => "PLAYER_QUIT",
            Self::PlayerMove => "PLAYER_MOVE",
            Self::PlayerJump => "PLAYER_JUMP",
            Self::PlayerTeleport => "PLAYER_TELEPORT",
            Self::PlayerChangeWorld => "PLAYER_CHANGE_WORLD",
            Self::PlayerToggleSprint => "PLAYER_TOGGLE_SPRINT",
            Self::PlayerToggleSneak => "PLAYER_TOGGLE_SNEAK",
            Self::Chat => "CHAT",
            ...
            Self::PlayerSkinChange => "PLAYER_SKIN_CHANGE",
            Self::PlayerFireExtinguish => "PLAYER_FIRE_EXTINGUISH",
            Self::PlayerStartBreak => "PLAYER_START_BREAK",
            Self::PlayerBlockBreak => "PLAYER_BLOCK_BREAK",
            Self::PlayerBlockPlace => "PLAYER_BLOCK_PLACE",
            Self::PlayerBlockPick => "PLAYER_BLOCK_PICK",
            Self::PlayerItemUse => "PLAYER_ITEM_USE",
            Self::PlayerItemUseOnBlock => "PLAYER_ITEM_USE_ON_BLOCK",
            Self::PlayerItemUseOnEntity => "PLAYER_ITEM_USE_ON_ENTITY",
            Self::PlayerItemRelease => "PLAYER_ITEM_RELEASE",
            Self::PlayerItemConsume => "PLAYER_ITEM_CONSUME",
            Self::PlayerAttackEntity => "PLAYER_ATTACK_ENTITY",
            Self::PlayerExperienceGain => "PLAYER_EXPERIENCE_GAIN",
            Self::PlayerPunchAir => "PLAYER_PUNCH_AIR",
            Self::PlayerSignEdit => "PLAYER_SIGN_EDIT",
            Self::PlayerLecternPageTurn => "PLAYER_LECTERN_PAGE_TURN",
            Self::PlayerItemDamage => "PLAYER_ITEM_DAMAGE",
            Self::PlayerItemPickup => "PLAYER_ITEM_PICKUP",
            Self::PlayerHeldSlotChange => "PLAYER_HELD_SLOT_CHANGE",
            Self::PlayerItemDrop => "PLAYER_ITEM_DROP",
            Self::PlayerTransfer => "PLAYER_TRANSFER",
            Self::Command => "COMMAND",
            Self::PlayerDiagnostics => "PLAYER_DIAGNOSTICS",
            Self::WorldLiquidFlow => "WORLD_LIQUID_FLOW",
            Self::WorldLiquidDecay => "WORLD_LIQUID_DECAY",
            Self::WorldLiquidHarden => "WORLD_LIQUID_HARDEN",
            Self::WorldSound => "WORLD_SOUND",
            Self::WorldFireSpread => "WORLD_FIRE_SPREAD",
            Self::WorldBlockBurn => "WORLD_BLOCK_BURN",
            Self::WorldCropTrample => "WORLD_CROP_TRAMPLE",
            Self::WorldLeavesDecay => "WORLD_LEAVES_DECAY",
            Self::WorldEntitySpawn => "WORLD_ENTITY_SPAWN",
            Self::WorldEntityDespawn => "WORLD_ENTITY_DESPAWN",
